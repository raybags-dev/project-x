...
//           isSuperUser: CONTEXT_USER_ELEVATED_STATUS,
//           isSubscribed: true,
//         };

//     const currentUser = context_user;
//     const perPage = 10;
...
//       current_page_count: users.length,
//       user_profiles: users,
//     });
//   } catch (error) {
//     logger(
//       `Error from <GetAllUsersController> getting user profiles...: ${error}`,
//       "error"
//     );
//     if (respondToClient) {
